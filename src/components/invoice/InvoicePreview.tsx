                ...
                <div>
                  ...
                  <div className="mb-6">
                    <table className="w-full border-collapse border border-gray-300 text-xs">
                      <thead>
                        <tr style={{ backgroundColor: primaryColor }} className="text-black font-bold border-b border-gray-300">
                        ...
                        {pageItems.map((item: any, index: number) => {
                          ...
                          return (
                            <tr key={index} className="border-b border-gray-300">
                              <td className="border border-gray-300 p-2 font-bold uppercase">
                              ...
                              <td className="border border-gray-300 p-2 text-center uppercase font-semibold">
                                {unit}
                              </td>
                              <td className="border border-gray-300 p-2 text-right font-mono">
              ...
              <div className="absolute left-[2mm] right-[2mm] top-[3.5mm] bottom-[2mm] grid grid-cols-[66mm_69mm_1fr] gap-x-[2mm]">
                ...
                <section className="flex flex-col justify-end h-full">
                  <div className="relative pl-[4.2mm]">
                    <div
                      className="absolute left-0 top-[0.5mm] bottom-[0.5mm] w-[0.75mm]"
                      style={{ backgroundColor: primaryColor }}
                    />
                ...
                <section className="relative h-full">
                  {settings?.footer_logo_data ? (
                    ...
                    <div className="absolute top-0 left-0 h-[8mm] flex items-center font-extrabold text-[9pt] text-red-700 tracking-tighter uppercase" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                      MOBINO <span className="font-normal text-[7pt] text-gray-700 ml-1">GROUP</span>
                    </div>
                  )}

                  {/* Contact Info (Bottom Aligned) */}
                  <div className="absolute bottom-0 left-0 w-full grid grid-cols-[20mm_1fr] gap-x-[2.5mm]">
                    {/* QR Box / Icon */}
                    <div className="w-[18mm] h-[18mm] flex items-center justify-center text-gray-500 font-bold text-[7pt] overflow-hidden">
