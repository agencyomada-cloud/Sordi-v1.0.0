                ...
                <div className="pb-[15mm]">
                  <div className="flex gap-3 mb-5">
                    <div className="flex-1 bg-gray-50 rounded-[10px] p-3.5">
                      <div className="text-[7pt] uppercase tracking-wide font-bold mb-1.5" style={{ color: accent }}>{recipientLabel}</div>
                  ...
                  <div className="rounded-[10px] overflow-hidden mb-4 text-[8.5pt]" style={{ border: `0.75px solid ${accent}30` }}>
                    <div className="flex items-center gap-2 px-2.5 py-1.5" style={{ backgroundColor: accent }}>
                      ...
                      {showPricing && <div className="w-[120px] text-right text-[7.5pt] uppercase font-bold tracking-wide" style={{ color: headerTextColor }}>P.U (HT)</div>}
                      ...
                      {showPricing && <div className="w-[130px] text-right text-[7.5pt] uppercase font-bold tracking-wide" style={{ color: headerTextColor }}>Total HT</div>}
                  ...
                  {(() => {
                    ...
                    // (showPricing false) — notes get the full row width.
                    if (!showPricing) {
                      return isFirstPage && <div className="mb-5">{notesBox}</div>;
                    }
                  ...
                  {isLastPage && (
                    <>
                      ...
                      <div className={cn("flex justify-end items-end", !(showMontantEnLettres && readInvoiceBoolSetting(settings?.show_amount_in_words, false)) && "mt-8")}>
                        ...
                        <div className="flex flex-col items-center relative" style={{ minWidth: "160px" }}>
                          {(settings?.stamp_data || settings?.signature_data) && (
                            <>
                              <div className="text-[7.5pt] text-gray-400 uppercase tracking-wide">{stampLabel || "Cachet et signature"}</div>
