...
export function InvoiceTemplateModerne({ invoice, settings }: InvoiceTemplateModerneProps) {
  ...
  const styles = StyleSheet.create({
    page: { width: 595.28, height: 841.89, padding: 0, fontFamily: 'Space Grotesk', fontSize: 9, color: '#111827', backgroundColor: '#ffffff' },
    ...
    companyNameWhite: { fontSize: 12, fontFamily: 'Space Grotesk', fontWeight: 'bold', color: '#ffffff', letterSpacing: 0.3 },
    headerRight: { alignItems: 'flex-end' },
    docTitle: { fontSize: 17, fontFamily: 'Space Grotesk', fontWeight: 'bold', color: '#ffffff', textTransform: 'uppercase', letterSpacing: 1.2 },
    ...
    cardLabel: { fontSize: 7, color: accent, textTransform: 'uppercase', letterSpacing: 0.8, fontFamily: 'Space Grotesk', fontWeight: 'bold', marginBottom: 6 },
    clientName: { fontSize: 10.5, fontFamily: 'Space Grotesk', fontWeight: 'bold', color: '#111827', textTransform: 'uppercase', marginBottom: 3 },
    ...
    metaRowValue: { fontSize: 8.5, fontFamily: 'Space Grotesk', fontWeight: 'bold', color: '#111827' },
    ...
    tableHeaderCell: { fontSize: 7.5, color: accent, textTransform: 'uppercase', letterSpacing: 0.6, fontFamily: 'Space Grotesk', fontWeight: 'bold' },
    ...
    itemName: { fontSize: 9, color: '#111827', fontFamily: 'Space Grotesk', fontWeight: 'bold' },
    ...
    ttcLabel: { fontSize: 9.5, fontFamily: 'Space Grotesk', fontWeight: 'bold', color: '#ffffff' },
    ttcValue: { fontSize: 11, fontFamily: 'Space Grotesk', fontWeight: 'bold', color: '#ffffff' },
    ...
    paymentText: { fontSize: 8, color: accent, fontFamily: 'Space Grotesk', fontWeight: 'bold' },
