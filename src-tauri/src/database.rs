...
pub fn init_database(db_path: &str) -> Result<Connection, rusqlite::Error> {
    ...
    let default_settings = [
        ("company_name", "SARL MOBINO ADJAL CONCASSAGE"),
        ("company_address", "Bp N°61,Kef Erand, Ain-Roua,19310,Sétif-Algérie "),
        ("company_rc", "04B0085776"),
        ("company_nif", "000419008577618"),
        ("company_nis", "000419060730849"),
        ("company_ai", "19060412832"),
        ("company_rib", "004.00364.400.000.4811.36 CPA SETIF "),
        ...
        ("stamp_data", ""),
        ("signature_data", ""),
        ("company_email", "contact@mobinoadjal.com"),
        ("company_phone", "0669951620, 0770311560"),
        ...
        ("company_phones", "[\"0669951620\",\"0770311560\"]"),
        ("company_website", "www.mobinoadjal.com"),
        ("company_bank_agency", "Agence 364 CPA BD CHELIHI KOIDER,19000 SETIF ALGERIA"),
